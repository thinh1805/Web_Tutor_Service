...
function AppointmentSuccessfully(){
    ...
    useEffect(()=>{
        axios.get(`http://localhost/projectnew/public/api/tutor/appoint/sucessfully/`+ id_tutor)
        .then(response=>{
            ...
            return getData.map((value)=>{
                return(
                    <div className="padding">
                        <div className="row AppointmentSuccessfully-content mb-5">
                            <div className="col-sm-2 mt-3">
                                        <div className="AppointmentSuccessfully-content-avatar">
                                            <img src={"http://localhost/projectnew/public/image/Image15.png"} alt="" />
                                        </div>
                            </div>
                            <div className="col-sm-8 mt-3">
                                            <div className="AppointmentSuccessfully-content-name">
                                            <h5>{value.name}</h5>
                                            </div>
                                            <div className="AppointmentSuccessfully-content-detail">
                                            <div className="AppointmentSuccessfully-content-detail-title">
                                                <p>{value.title}</p>
                                            </div>
                                            <div className="AppointmentSuccessfully-content-detail-subject">
                                                <p>Subject: {value.subject}</p>
                                            </div>
                                            <div className="AppointmentSuccessfully-content-detail-form">
                                                <p>Class: <span>{value.class}</span></p>
                                            </div>
                                            <div className="AppointmentSuccessfully-content-detail-price">
                                                <p>Tuition/ 1 student: <span>{value.price}k</span></p>
                                            </div>
                                            <div className="AppointmentSuccessfully-content-detail-address">
                                    ...
                                    <div className="col-sm-6">
                                        <div className="row">
                                            ...
                                            <div className="col-sm-9 notification">
                                                <p>Your Appointment Is Accepted</p>
                                            </div>
                                        </div>
                                    </div>
